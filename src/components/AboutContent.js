      ...
      <div className="about-content">
        ...
        <div className="about-text-container">
          <div className="about-text-inner-container">
            ...
            <p className="about-text">
              Born in Cambridge UK to an English mother and German father, his
              childhood was spent living between Cambridge and Berlin. He is
              bilingual, speaking English and German. His love of photography
              started in Berlin at the age of ten, when his photographer
              Grandmother gave him his first camera.
            </p>
            <p className="about-text">
              He studied photography at Berlin University of the Arts, where he
              earned a Bachelor of Arts &#40;BA&#41;. Brandon then travelled
              extensively in the US and Canada working with many influential
              photographers and developing his signature style.
            </p>
            <p className="about-text">
